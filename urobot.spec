...
hidden_imports = [
    ...
    'src.movements.arc_force',
    'src.movements.arc_force.widget',
    'src.movements.arc_force.servol',
    'src.movements.arc_force.speedl',
    'src.movements.arc_force.movel',
    'src.movements.arc_x',
    'src.movements.arc_x.widget',
    'src.movements.arc_x.movel',
    'src.movements.arc_y',
    'src.movements.arc_y.widget',
    'src.movements.arc_y.movel',
    'src.movements.arc_z',
    'src.movements.arc_z.widget',
    'src.movements.arc_z.movel',
