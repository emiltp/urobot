"""NewY movement widget for embedding in the main window."""
...
from . import original as new_y_original
from . import hybrid as new_y_hybrid
from . import force as new_y_force
...
class NewYWidget(QWidget):
    """Widget containing new-y movement controls."""
    ...
    def __init__(self, app):
        ...
        info_label = QLabel("New (y) motion — placeholder description.")
        ...
        self.angle_input.setValue(CONFIG.new_y.angle)
        ...
        self.speed_input.setValue(CONFIG.new_y.speed)
        ...
        self.accel_input.setValue(CONFIG.new_y.acceleration)
        ...
        self.gain_input.setValue(CONFIG.new_y_original.force_control_gain)
        ...
        self.deadband_input.setValue(CONFIG.new_y_original.force_deadband)
        ...
        self.max_adj_input.setValue(CONFIG.new_y_original.max_adjustment_per_step)
        ...
        self.interval_input.setValue(CONFIG.new_y_original.min_adjustment_interval)
        ...
        self.hybrid_z_limit_input.setValue(CONFIG.new_y_hybrid.force_mode_z_limit)
        ...
        self.hybrid_damping_input.setValue(CONFIG.new_y_hybrid.force_mode_damping)
        ...
        self.force_z_limit_input.setValue(CONFIG.new_y_force.force_mode_z_limit)
        ...
        self.force_damping_input.setValue(CONFIG.new_y_force.force_mode_damping)
        ...
        self.force_gain_scaling_input.setValue(CONFIG.new_y_force.force_mode_gain_scaling)
        ...
        self.control_dt_input.setValue(CONFIG.new_y_force.control_loop_dt)
        ...
        self.rot_speed_factor_input.setValue(CONFIG.new_y_force.rotation_speed_factor)
    ...
    def _get_current_method_module(self):
        ...
        return METHOD_MODULES.get(method, new_y_original)
    ...
    def _update_endpoint_visualization(self):
        """Compute the TCP endpoint orbited around the Ref frame's local y-axis."""
        checked_button = self.direction_group.checkedButton()
    ...
    def collectWaypoints(self):
        """Execute new-y movement and save path."""
        checked_button = self.direction_group.checkedButton()
        ...
        if hasattr(self.app, '_disable_freedrive_for_movement'):
            self.app._disable_freedrive_for_movement("new-y movement")
        
        try:
            start_position = list(self.app.robot.rtdeReceive.getActualTCPPose())
            print(f"\n=== New-Y Movement (Set Path) ===")
            ...
            print(f"Error during new-y set path: {e}")
            import traceback
            traceback.print_exc()
            self.reset_button_style()
